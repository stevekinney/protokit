...
// One representative, unambiguous value per credential type this template
// handles. Each is distinctive enough that an accidental substring match
// elsewhere in the log line would be implausible.
const canaries = {
