	...
	return jsonResponse(
		{
			...
			extensions: {
				...
				// correctly suppressed it via `hasRegisteredUiExtensionResource(templateRegistry)`
				...
				ui: environment.mcpEnableUiExtension && hasRegisteredUiExtensionResource(templateRegistry),
			},
